...
func (x *ValidateRequest) GetA() uint64 {
	if x != nil {
		return x.A
	}
	return 0
...
func (x *ValidateRequest) GetB() uint64 {
	if x != nil {
		return x.B
	}
	return 0
...
func (x *ValidateRequest) GetC() uint64 {
	if x != nil {
		return x.C
	}
	return 0
...
var file_mult_proto_rawDesc = []byte{
	...
	0x75, 0x6c, 0x74, 0x22, 0x3b, 0x0a, 0x0f, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x65, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x0c, 0x0a, 0x01, 0x61, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x04, 0x52, 0x01, 0x61, 0x12, 0x0c, 0x0a, 0x01, 0x62, 0x18, 0x02, 0x20, 0x01, 0x28, 0x04, 0x52,
	...
	0x01, 0x28, 0x08, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x32, 0x76, 0x0a, 0x0b, 0x4d, 0x75,
	0x6c, 0x74, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x2e, 0x0a, 0x07, 0x43, 0x6f, 0x6d,
	0x70, 0x75, 0x74, 0x65, 0x12, 0x0f, 0x2e, 0x70, 0x62, 0x2e, 0x4d, 0x75, 0x6c, 0x74, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x10, 0x2e, 0x70, 0x62, 0x2e, 0x4d, 0x75, 0x6c, 0x74, 0x52,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x37, 0x0a, 0x08, 0x56, 0x61, 0x6c,
...
var file_mult_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
...
var file_mult_proto_depIdxs = []int32{
	...
	2, // 1: pb.MultService.Validate:input_type -> pb.ValidateRequest
	1, // 2: pb.MultService.Compute:output_type -> pb.MultResponse
	3, // 3: pb.MultService.Validate:output_type -> pb.ValidateResponse
...
func (c *multServiceClient) Validate(ctx context.Context, in *ValidateRequest, opts ...grpc.CallOption) (*ValidateResponse, error) {
	out := new(ValidateResponse)
	err := c.cc.Invoke(ctx, "/pb.MultService/Validate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedMultServiceServer) Validate(context.Context, *ValidateRequest) (*ValidateResponse, error) {
...
func _MultService_Validate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ValidateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MultServiceServer).Validate(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.MultService/Validate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MultServiceServer).Validate(ctx, req.(*ValidateRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _MultService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Validate",
			Handler:    _MultService_Validate_Handler,
		},
	},
